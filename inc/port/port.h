...
const QStringList port_dr = {P1DR, P2DR, P3DR, P4DR, P5DR, P6DR,
                             P7DR, P8DR, P9DR, PADR, PBDR};

const QStringList port_ddr = {P1DDR, P2DDR, P3DDR, P4DDR, P5DDR, P6DDR,
                              P7DDR, P8DDR, P9DDR, PADDR, PBDDR};
